...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon;
        icon.addFile(QStringLiteral(":/images/Liecoin"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        m_aboutLiecoinAction = new QAction(MainWindow);
        m_aboutLiecoinAction->setObjectName(QStringLiteral("m_aboutLiecoinAction"));
        m_aboutLiecoinAction->setEnabled(true);
        ...
        menuHelp->addAction(m_aboutLiecoinAction);
        ...
        QObject::connect(m_aboutLiecoinAction, SIGNAL(triggered()), MainWindow, SLOT(about()));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
...
#endif // QT_NO_TOOLTIP
        m_aboutLiecoinAction->setText(QApplication::translate("MainWindow", "About Liecoin", Q_NULLPTR));
        ...
        m_sendButton->setText(QApplication::translate("MainWindow", "SEND LiecoinS", Q_NULLPTR));
