...
const char COMMUNITY_FORUM_URL[] = "https://Liecoin-coin.herokuapp.com";
const char REPORT_ISSUE_URL[] = "https://Liecoin.com/#contact";
...
MainWindow::MainWindow(ICryptoNoteAdapter* _cryptoNoteAdapter, IAddressBookManager* _addressBookManager,
  ...
  m_ui->setupUi(this);
  setWindowTitle(tr("Liecoin Wallet %1").arg(Settings::instance().getVersion()));
